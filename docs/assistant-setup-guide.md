...
5. Copy the content of `prompts/assistants/prompt_generator/system.xml`
6. Paste into project instructions
7. Drag and drop all the files in the `prompts/assistants/prompt_generator/examples/` folder
8. See this [example](../prompts/assistants/prompt_generator/examples/readme_writer.xml) for guidance on how to use the Prompt Generator.
...
- `prompts/assistants/prompt_generator/system.xml`.
- All the files in the `prompts/assistants/prompt_generator/examples/` folder.
6. See this [example](../prompts/assistants/prompt_generator/examples/readme_writer.xml) for guidance on how to use the Prompt Generator.
...
2. Write a name for the project (e.g., "Prompt Generator").
3. Copy the content of `prompts/assistants/prompt_generator/system.xml` under `Instructions`.
4. Drag and drop all the files in the `prompts/assistants/prompt_generator/examples/` folder under `Knowledge`.
5. Click `Save`.
6. See this [example](../prompts/assistants/prompt_generator/examples/readme_writer.xml) for guidance on how to use the Prompt Generator.
...
1. Copy the contents of any the `prompts/assistants/prompt_generator/system.xml` file
2. Paste directly at the start of a conversation
3. See this [example](../prompts/assistants/prompt_generator/examples/readme_writer.xml) for guidance on how to use the Prompt Generator.
